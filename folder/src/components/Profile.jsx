...
import getBookmark from '../hooks/getBookmark';
    ...
    <>
      ...
      <div className='mt-4'>
        ...
        {activeTab === "bookmarked" &&
          <div className='text-blue-500 flex items-center text-lg font-bold'>
            {
              posts.bookmark.map((book, index) => {
                return <div key={index}>
                  <div>
                    <p>{book.caption}</p>
                    <img className='h-52' src={book.images[0]} alt="" />
                  </div>
